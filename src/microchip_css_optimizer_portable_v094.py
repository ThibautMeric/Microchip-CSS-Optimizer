...
def ConfigureCanvasStep2(event):
    ...
    print("in:"+ str(frame.winfo_width()))
...
def RefreshStep2(event):
    ...
    # Update the display
    FillCanvasStep2()
    print("out:"+ str(frame.winfo_width()))
...
TextHtml = StringVar()
entryHtml = tk.Entry(lfStep1, textvariable=TextHtml, width=int(42*coef), validate='key',validatecommand=EnableAddHtml)
